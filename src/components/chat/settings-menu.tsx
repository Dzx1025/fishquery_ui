    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={`p-2 rounded-full hover:bg-muted transition-all duration-200 group ${isOpen ? "bg-muted text-primary" : "text-muted-foreground"
                    }`}
                title="Settings"
            >
                <Settings className={`h-5 w-5 transition-transform duration-300 ${isOpen ? "rotate-90 text-primary" : "group-hover:rotate-45"}`} />
            </button>
                ...
                <div className="absolute right-0 top-full mt-3 w-64 bg-card/95 backdrop-blur-md border border-border rounded-2xl shadow-2xl py-3 z-50 animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                                ...
                                {themes.map((t) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex flex-col items-center justify-center gap-1.5 py-3 rounded-xl transition-all duration-200 ${isActive
                    ...
                    <div className="mt-4 px-2 pt-2 border-t border-border/50">
                        <div className="px-3 py-1 mb-1">
                            <span className="text-[10px] font-bold text-muted-foreground/50 uppercase tracking-tight">System Info</span>
                        </div>
